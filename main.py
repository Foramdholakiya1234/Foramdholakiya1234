    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:\Users\Tej\Desktop\python\Attendace_management_system-master\Attendance\Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Tej\Desktop\python\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
